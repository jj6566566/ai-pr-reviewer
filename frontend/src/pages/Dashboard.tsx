...
type DashboardMode = 'single' | 'batch' | 'trends';
  ...
  return (
    <div className="min-h-screen px-4 pb-16">
      ...
      <div className="flex justify-center mb-8">
        ...
        <Link
          to="/settings"
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium text-slate-500 hover:text-slate-300 hover:bg-slate-800/40 transition-all duration-200"
        >
